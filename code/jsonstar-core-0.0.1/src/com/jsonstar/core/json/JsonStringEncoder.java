...
import com.jsonstar.core.type.CharTypes;
import com.jsonstar.core.util.BufferRecycler;
import com.jsonstar.core.util.ByteArrayBuilder;
...
public final class JsonStringEncoder
{
	...
	private void _throwIllegalSurrogate(int code)
	{
		if (code > 0x10FFFF)
		{ // over max?
			throw new IllegalArgumentException("Illegal character point (0x" + Integer.toHexString(code)
