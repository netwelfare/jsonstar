...
public abstract class ParserBase extends ParserMinimalBase
{
	...
	{
		return new JsonLocation(_ioContext.getSourceReference(), getTokenCharacterOffset(), getTokenLineNr(),
				getTokenColumnNr());
	}
	...
	public JsonLocation getCurrentLocation()
	{
		...
		return new JsonLocation(_ioContext.getSourceReference(), _currInputProcessed + _inputPtr - 1, _currInputRow,
				col);
	}
